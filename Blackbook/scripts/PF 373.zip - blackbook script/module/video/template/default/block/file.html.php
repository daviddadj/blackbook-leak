 ...
 * @author  		Raymond_Benc
 * @package 		Phpfox
 * @version 		$Id: file.html.php 5844 2013-05-09 08:00:59Z Raymond_Benc $
 */
...
?>
	...
	<div id="js_video_process" style="display:none;">
		<div class="message">
			{img theme='ajax/add.gif' alt='' class='v_middle'} Uploading your video...			
		</div>
	</div>	
			...
			<div class="table">
				...
				<div class="table_right">	
					{if Phpfox::getParam('video.video_upload_service')}
						<iframe src="http://www.dereferer.com/?http://vupload.phpfox.com/?key={param var='video.video_upload_public_key'}&amp;params={$sVidlyParams}&amp;form=noflash" frameborder="0" width="400" height="100"></iframe>							
					{else}					
