 ...
 * @version 		$Id: process.class.php 6343 2013-07-19 19:42:10Z Raymond_Benc $
 */
		...
		*/
		...
		else
		{
			...
			*/
			...
			// Phpfox::getLib('request')->send('', array('id' => $iUploadVideoId, 'action' => 'delete', 'key' => Phpfox::getParam('video.video_upload_public_key')));
