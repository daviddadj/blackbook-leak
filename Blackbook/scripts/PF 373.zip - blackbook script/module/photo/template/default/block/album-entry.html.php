 ...
 * @version 		$Id: album-entry.html.php 6887 2013-11-13 19:29:40Z Fern $
 */
 
defined('PHPFOX') or exit('NO DICE!'); 

?>
<div class="t_center photo_row {if !Phpfox::getParam('photo.show_info_on_mouseover')}album_entry{/if}" id="js_photo_album_id_{$aAlbum.album_id}">
