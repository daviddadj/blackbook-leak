 ...
 * @version 		$Id: process.class.php 6815 2013-10-21 15:26:41Z Miguel_Espinoza $
 */
class Forum_Service_Thread_Process extends Phpfox_Service 
{
	...
	public function delete($iThread)
	{
		...
		else 
		{
			...
			{
				$this->database()->update(Phpfox::getT('forum'), array('thread_id' => 0, 'post_id' => 0, 'last_user_id'), 'thread_id = ' . $aThread['forum_id']);	
			}			
		}		
